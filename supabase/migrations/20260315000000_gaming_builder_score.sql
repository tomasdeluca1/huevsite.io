-- Migration: Gaming & Engagement signals in Builder Score
-- Date: 2026-03-15

-- 1. Función para recalcular el score de un usuario específico (Lógica Gaming)
...
BEGIN
  ...
  -- G. Pro Power-Ups (Gaming)
  -- 1. Sub-sites: +80 el primero, +40 c/u extra (cap 5)
  ...
  -- 2. Dominio custom: +150 pts
  IF v_profile.custom_domain IS NOT NULL AND v_profile.custom_domain != '' THEN
    v_score := v_score + 150;
  END IF;
...
-- 2. Función para obtener el desglose detallado (Breakdown)
...
-- 3. HELPER: Recalcular TODO de una vez
