...
export function MobileStickyHeader({ displayName, avatarUrl, builderScore, accentColor, username }: MobileHeaderProps) {
...
export function MobileBottomNav({ accentColor, currentUserId }: { accentColor: string; currentUserId?: string | null }) {
    return (
